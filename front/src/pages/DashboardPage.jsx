...
const DashboardPage = () => {
  ...
  const fetchData = useCallback(async () => {
    try {
      ...
      if (
        ...
        const { tickets: cachedTickets, users: cachedUsers } =
  ...
  useEffect(() => {
    ...
    if (tickets.length > 0) {
      // Debugging code removed to fix unused variables
