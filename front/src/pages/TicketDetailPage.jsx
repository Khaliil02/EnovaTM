...
const TicketDetailPage = () => {
  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        ...
        const [ticketResponse, usersResponse, departmentsResponse] =
          await Promise.all([
        ...
        if (ticketData.destination_department_id) {
          setSelectedDepartmentId(
            ticketData.destination_department_id.toString()
          );
        }
  ...
  useEffect(() => {
    if (selectedDepartmentId) {
      const usersInDepartment = users.filter(
        (u) => u.department_id === parseInt(selectedDepartmentId)
      );
  ...
  const renderAttachmentViewer = () => {
    ...
    const isImage = viewingAttachment.mime_type?.startsWith("image/");
    const isPdf = viewingAttachment.mime_type === "application/pdf";
    const viewUrl = getAttachmentViewUrl(viewingAttachment.id);
        ...
        <div className="bg-white rounded-lg shadow-xl max-w-4xl w-full max-h-screen overflow-hidden">
          <div className="p-4 border-b flex justify-between items-center">
            <h3 className="font-semibold text-lg">
              {viewingAttachment.original_filename || "File Preview"}
            </h3>
            <button
      ...
      <div className="bg-white rounded-lg shadow-md overflow-hidden mb-6">
        <div className="border-b border-gray-200 px-6 py-4">
          ...
          <div className="mt-2 text-sm text-gray-500">
            ...
            {new Date(ticket.creation_date).toLocaleDateString()} • Last updated{" "}
            ...
            <div className="mt-6 bg-red-50 p-4 rounded-md">
              <div className="flex">
                ...
                <div>
                  ...
                  <p className="mt-1 text-sm text-red-700">
                    Escalated by:{" "}
                    {ticket.escalated_by
                      ? getUserName(ticket.escalated_by)
                      : "Unknown"}
                  </p>
                </div>
              </div>
              ...
              {canReassign && (
                ...
                >
                  ...
                  <div className="mb-3">
                    <label className="block text-sm text-red-800 mb-1">
                      Select Department
                    </label>
                    <select
                  ...
                  <button
                    ...
                    className="btn bg-red-600 text-white hover:bg-red-700"
                    disabled={
                      loading || !selectedDepartmentId || !reassignUserId
                    }
                  >
              ...
              <form onSubmit={handleEscalate}>
                ...
                <div className="mb-3">
                  <label
                    ...
                    className="block text-sm text-yellow-800 mb-1"
                  >
              ...
              <div className="flex">
                ...
                <div>
                  ...
                  <p className="mt-1 text-sm text-green-700">
                    Closed by:{" "}
                    {ticket.closed_by
                      ? getUserName(ticket.closed_by)
                      : "Unknown"}
                  </p>
                  <p className="mt-1 text-sm text-green-700">
                    Resolution date:{" "}
                    {ticket.resolution_date
                      ? new Date(ticket.resolution_date).toLocaleString()
                      : "Unknown"}
                  </p>
                </div>
              </div>
