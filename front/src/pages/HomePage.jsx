...
import { FiArrowRight, FiCheckCircle, FiUsers, FiMessageSquare, FiBarChart2 } from 'react-icons/fi';
import logoImage from '../assets/enova-tm-logo.png'; // Create or use a logo image
      ...
      <div className="max-w-7xl mx-auto py-16 px-4 sm:px-6 lg:px-8">
        <div className="text-center">
          ...
          <p className="mt-6 max-w-lg mx-auto text-xl text-gray-500">
            A modern ticket management system designed for efficient issue tracking, assignment, and resolution.
          </p>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center">
            ...
            <p className="mt-4 text-lg text-gray-500">
              Everything you need to manage your department's communication efficiently
            </p>
          </div>
          ...
          <div className="mt-16">
            <div className="grid grid-cols-1 gap-8 md:grid-cols-3">
              <div className="bg-primary-50 border border-primary-100 rounded-xl p-8 transition-all duration-300 hover:shadow-xl hover:-translate-y-1">
                ...
                <h3 className="text-xl font-medium text-gray-900 text-center">Department-based Ticketing</h3>
              ...
              <div className="bg-primary-50 border border-primary-100 rounded-xl p-8 transition-all duration-300 hover:shadow-xl hover:-translate-y-1">
                ...
                <h3 className="text-xl font-medium text-gray-900 text-center">Escalation Workflow</h3>
                <p className="mt-4 text-base text-gray-600 text-center">
                  Escalate complex issues to administrators with detailed reasoning for faster resolution.
                </p>
              </div>
              ...
              <div className="bg-primary-50 border border-primary-100 rounded-xl p-8 transition-all duration-300 hover:shadow-xl hover:-translate-y-1">
                ...
                <h3 className="text-xl font-medium text-gray-900 text-center">Priority Management</h3>
                <p className="mt-4 text-base text-gray-600 text-center">
                  Assign priorities to ensure critical issues are addressed first with visual analytics.
                </p>
              </div>
            </div>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            <div className="bg-white p-6 rounded-lg shadow-sm hover:shadow-md transition-all duration-200">
              <div className="flex items-center mb-4">
                ...
                <h3 className="text-xl font-medium text-gray-900">Improved Response Time</h3>
              </div>
              <p className="text-gray-600">Reduce ticket resolution time by up to 40% with proper assignment and prioritization.</p>
            </div>
            
            <div className="bg-white p-6 rounded-lg shadow-sm hover:shadow-md transition-all duration-200">
              <div className="flex items-center mb-4">
                <FiCheckCircle className="h-6 w-6 text-primary-600 mr-3" />
                <h3 className="text-xl font-medium text-gray-900">Cross-Department Collaboration</h3>
              </div>
              <p className="text-gray-600">Break down silos and improve communication between different departments.</p>
            </div>
            
            <div className="bg-white p-6 rounded-lg shadow-sm hover:shadow-md transition-all duration-200">
              <div className="flex items-center mb-4">
                <FiCheckCircle className="h-6 w-6 text-primary-600 mr-3" />
                <h3 className="text-xl font-medium text-gray-900">Data-Driven Insights</h3>
              </div>
              <p className="text-gray-600">Gain valuable insights with advanced analytics on ticket volume, resolution time, and more.</p>
            </div>
            
            <div className="bg-white p-6 rounded-lg shadow-sm hover:shadow-md transition-all duration-200">
              <div className="flex items-center mb-4">
                <FiCheckCircle className="h-6 w-6 text-primary-600 mr-3" />
                <h3 className="text-xl font-medium text-gray-900">User Accountability</h3>
              </div>
              <p className="text-gray-600">Track ownership of issues and create clear accountability for faster resolutions.</p>
            </div>
          </div>
        </div>
      </div>
